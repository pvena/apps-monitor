...
public class SoapSynchronizeInfoReceived extends AsyncTask<Void, Void, String>{

	public final String SOAP_ACTION = "http://tesis.org/getSynchInfo";
	public  final String OPERATION_NAME = "getSynchInfo"; 
	public  final String WSDL_TARGET_NAMESPACE = "http://tesis.org/";
	private String SOAP_ADDRESS = "";
	
	private String result;
	
	public SoapSynchronizeInfoReceived() 
	{ 
	...
	protected String doInBackground(Void... v)
	{
		try
		{
			...
			LogFormat.setInfoReceived(bodyIn.getPropertyAsString(0));
			
			this.result = "Refresh Info OK.";
		}
